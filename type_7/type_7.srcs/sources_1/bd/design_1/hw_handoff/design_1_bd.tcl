...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set lcd_out_0 [ create_bd_port -dir O -from 6 -to 0 lcd_out_0 ]
  set seg_out_0 [ create_bd_port -dir O -from 3 -to 0 seg_out_0 ]

  # Create instance: Segment_Controller_0, and set properties
  set block_name Segment_Controller
  set block_cell_name Segment_Controller_0
  if { [catch {set Segment_Controller_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Segment_Controller_0 eq "" } {
  ...
  connect_bd_net -net Segment_Controller_0_lcd_out [get_bd_ports lcd_out_0] [get_bd_pins Segment_Controller_0/lcd_out]
  connect_bd_net -net Segment_Controller_0_seg_out [get_bd_ports seg_out_0] [get_bd_pins Segment_Controller_0/seg_out]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Segment_Controller_0/displayed_number] [get_bd_pins axi_gpio_0/gpio_io_o]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Segment_Controller_0/clock_100Mhz] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Segment_Controller_0/reset] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
